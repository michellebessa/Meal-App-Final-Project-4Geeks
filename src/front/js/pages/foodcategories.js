    ...
    <div className="container text-center mt-2" id="foodcategories">
      ...
      <p className="foodcategoriesdescription">
        <strong>
          ...
          the pantry items in your kitchen, listing each in the category that it
          belongs to.
        </strong>
      </p>
          ...
          <div className="col">
            <li className="list-group-item" id="foodcategories">
              ...
              <FoodCategoriesModal modalid="fatmodal">
                <h2>Healthy Fat</h2>
                Healthy Fat foods are known as the “good fats”, because they are
                good for your heart, your cholesterol, and your overall health.
                A small amount of fat is an essential part of a healthy,
                balanced diet. It's a source of essential fatty acids, which the
                body cannot make itself. Fat helps the body absorb vitamin A,
                vitamin D and vitamin E. These vitamins are fat-soluble, which
                means they can only be absorbed with the help of fats.{" "}
                <p>Examples of Healhy Fats are:</p>
                <p>
                  <strong>
          ...
          <div className="col">
            <li className="list-group-item" id="foodcategories">
              ...
              <FoodCategoriesModal modalid="proteinmodal">
                <h2>Protein</h2>Protein is found throughout the body—in muscle,
                ...
                the hemoglobin that carries oxygen in your blood. At least
                10,000 different proteins make you what you are and keep you
                that way. Protein is made from twenty-plus basic building blocks
                called amino acids. Because we don’t store amino acids, our
                bodies make them in two different ways: either from scratch, or
                by modifying others. Nine amino acids—histidine, isoleucine,
                leucine, lysine, methionine, phenylalanine, threonine,
                tryptophan, and valine-known as the essential amino acids, must
                come from food. <p>Examples of Proteins are:</p>
                <p>
                  <strong>
          ...
          <div className="col">
            <li className="list-group-item" id="foodcategories">
              ...
              <FoodCategoriesModal modalid="dairymodal">
                ...
                food products made from milk. Eating or drinking Dairy products
                offers health benefits, like building and maintaining strong
                bones. Dairy Group foods provide nutrients that are vital for
                the health and maintenance of the body. These nutrients include
          ...
          <div className="col">
            <li className="list-group-item" id="foodcategories">
              ...
              <FoodCategoriesModal modalid="grainscarbohydratesmodal">
                <h2>Grains/Carbohydrates</h2>Carbohydrates are your body's main
                source of energy: They help fuel your brain, kidneys, heart
                muscles, and central nervous system. For instance, fiber is a
                carbohydrate that aids in digestion, helps you feel full, and
              ...
              <FoodCategoriesModal modalid="vegetablesmodal">
                ...
                <p>
                  <strong>
                    ...
                    Beans, Kale, Lettuce, Cucumber, Onion, Spinach and Peppers.
                  </strong>
                </p>
              </FoodCategoriesModal>
            </li>
          ...
          <div className="col">
            <li className="list-group-item" id="foodcategories">
              ...
              <FoodCategoriesModal modalid="fruitsmodal">
                ...
                your skin look radiant, young and glowing as fruits are full of
                anti-oxidants.
