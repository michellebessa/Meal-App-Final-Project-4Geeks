          ...
          <div className="accordion-item">
            ...
            >
              <div className="accordion-body">
                <p>
                  Use our scanner to scan any food you have in your pantry and
                  then it will be saved in your pantry list.
                </p>
                <button
                ...
                <PantryModal modalid="pantryscanmodal">
                  <p>
                    <strong>
                      As soon as this modal opens, the computer will ask
                      permission to access my camera, so I can scan an item
                      barcode.
                    </strong>
                  </p>
                </PantryModal>
